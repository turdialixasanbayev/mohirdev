    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('user', 'User'), ('teacher', "O'qituvchi")], default='user', max_length=10)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(db_index=True, help_text='Telefon raqamingizni kiriting: ', max_length=15, region='UZ', unique=True)),
